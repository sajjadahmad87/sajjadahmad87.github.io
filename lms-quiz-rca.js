(()=>{
  ...
  const saveAttempt=score=>{
    ...
    lms.activity.unshift({type:'quiz-attempt',courseId:COURSE_ID,label:`RCA knowledge check: ${score}/${QUESTIONS.length}`,at});lms.activity=lms.activity.slice(0,40);lms.updatedAt=at;
